...
\lhead{LC\&B - 02.3 Numerical - Conor}
\rhead{\thepage}
\cfoot{}
\begin{document}
...
This section is here for anyone who is interested; it isn't part of
the unit and in the exam you will only be expected to what is written
above about the Runge-Kutta method, that it is a more accurate
alternative to the Euler approximation.
